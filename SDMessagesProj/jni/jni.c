...
JNIEXPORT void Java_com_sirisdevelopment_telegram_messenger_Utilities_aesIgeEncryption(JNIEnv *env, jclass class, jobject buffer, jbyteArray key, jbyteArray iv, jboolean encrypt, int offset, int length) {
...
JNIEXPORT jstring Java_com_sirisdevelopment_telegram_messenger_Utilities_readlink(JNIEnv *env, jclass class, jstring path) {
