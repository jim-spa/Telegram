...
static const char *NativeByteBufferClassPathName = "com/sirisdevelopment/telegram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "com/sirisdevelopment/telegram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILcom/sirisdevelopment/telegram/tgnet/RequestDelegateInternal;Lcom/sirisdevelopment/telegram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("com/sirisdevelopment/telegram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/sirisdevelopment/telegram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("com/sirisdevelopment/telegram/tgnet/ConnectionsManager"));
