...
import com.sirisdevelopment.telegram.ui.PopupNotificationActivity;
...
public class NotificationsController {
        ...
        notificationsQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    cv.put("tag", "com.sirisdevelopment.telegram.messenger/com.sirisdevelopment.telegram.ui.LaunchActivity");
                    cv.put("count", count);
    ...
    private void showExtraNotifications(NotificationCompat.Builder notificationBuilder, boolean notifyAboutLast) {
        ...
        for (int b = 0; b < sortedDialogs.size(); b++) {
            ...
            msgHeardIntent.setAction("com.sirisdevelopment.telegram.messenger.ACTION_MESSAGE_HEARD");
            ...
            if (!ChatObject.isChannel(chat) && !AndroidUtilities.needShowPasscode(false) && !UserConfig.isWaitingForPasscodeEnter) {
                ...
                msgReplyIntent.setAction("com.sirisdevelopment.telegram.messenger.ACTION_MESSAGE_REPLY");
