 ...
 */
package com.sirisdevelopment.telegram.messenger.exoplayer.smoothstreaming;

import com.sirisdevelopment.telegram.messenger.exoplayer.BehindLiveWindowException;
import com.sirisdevelopment.telegram.messenger.exoplayer.C;
import com.sirisdevelopment.telegram.messenger.exoplayer.MediaFormat;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.Chunk;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.ChunkExtractorWrapper;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.ChunkOperationHolder;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.ChunkSource;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.ContainerMediaChunk;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.Format;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.Format.DecreasingBandwidthComparator;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.FormatEvaluator;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.FormatEvaluator.Evaluation;
import com.sirisdevelopment.telegram.messenger.exoplayer.chunk.MediaChunk;
import com.sirisdevelopment.telegram.messenger.exoplayer.drm.DrmInitData;
import com.sirisdevelopment.telegram.messenger.exoplayer.drm.DrmInitData.SchemeInitData;
import com.sirisdevelopment.telegram.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import com.sirisdevelopment.telegram.messenger.exoplayer.extractor.mp4.Track;
import com.sirisdevelopment.telegram.messenger.exoplayer.extractor.mp4.TrackEncryptionBox;
import com.sirisdevelopment.telegram.messenger.exoplayer.smoothstreaming.SmoothStreamingManifest.ProtectionElement;
import com.sirisdevelopment.telegram.messenger.exoplayer.smoothstreaming.SmoothStreamingManifest.StreamElement;
import com.sirisdevelopment.telegram.messenger.exoplayer.smoothstreaming.SmoothStreamingManifest.TrackElement;
import com.sirisdevelopment.telegram.messenger.exoplayer.upstream.DataSource;
import com.sirisdevelopment.telegram.messenger.exoplayer.upstream.DataSpec;
import com.sirisdevelopment.telegram.messenger.exoplayer.util.Assertions;
import com.sirisdevelopment.telegram.messenger.exoplayer.util.CodecSpecificDataUtil;
import com.sirisdevelopment.telegram.messenger.exoplayer.util.ManifestFetcher;
import com.sirisdevelopment.telegram.messenger.exoplayer.util.MimeTypes;
