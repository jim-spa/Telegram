...
public class NativeLoader {
    ...
    public static synchronized void initNativeLibs(Context context) {
        Log.d("tmessages", "initNativeLibs +++++++++++  ");
        if (nativeLoaded) {
            return;
        }
        ...
        Log.d("tmessages", "initNativeLibs loaded constants +++++++++++  ");
        try {
            String folder;
            try {
            ...
            Log.d("tmessages", "initNativeLibs +++++++++++  folder: " + folder);
        ...
        Log.d("tmessages", "initNativeLibs +++++++++++  done");
    }
